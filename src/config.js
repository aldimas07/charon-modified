...
export const JUPITER_SWAP_BASE_URL = process.env.JUPITER_SWAP_BASE_URL || 'https://api.jup.ag/ultra/v1';
...
export const LLM_MAX_TOKENS = Number(process.env.LLM_MAX_TOKENS || 3000);
